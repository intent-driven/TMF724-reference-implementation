...
exports.deleteIncident = function(req, res, next) {
  /**
   * Deletes a Incident
   * This operation deletes a Incident entity.
   *
   * id String Identifier of the Incident
   * no response value expected for this operation
   **/

  console.log('deleteIncident :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.patchIncident = function(req, res, next) {
  /**
   * Updates partially a Incident
   * This operation updates partially a Incident entity.
   *
   * id String Identifier of the Incident
   * incident Incident_Update The Incident to be updated
   * returns Incident
   **/

  console.log('patchIncident :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchIncident',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchIncident error=" + error);
