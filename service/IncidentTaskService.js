...
exports.createIncidentTask = function(req, res, next) {
  /**
   * Creates a IncidentTask
   * This operation creates a IncidentTask entity.
   *
   * incidentTask IncidentTask_Create The IncidentTask to be created
   * returns IncidentTask
   **/

  console.log('createIncidentTask :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument incidentTask */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createIncidentTask', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createIncidentTask', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createIncidentTask: error=" + error);
    ...
    .catch( error => {
      console.log("createIncidentTask: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteIncidentTask = function(req, res, next) {
  /**
   * Deletes a IncidentTask
   * This operation deletes a IncidentTask entity.
   *
   * id String Identifier of the IncidentTask
   * no response value expected for this operation
   **/

  console.log('deleteIncidentTask :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listIncidentTask = function(req, res, next) {
  /**
   * List or find IncidentTask objects
   * This operation list or find IncidentTask entities
   *
  ...
  console.log('listIncidentTask :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listIncidentTask: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchIncidentTask = function(req, res, next) {
  /**
   * Updates partially a IncidentTask
   * This operation updates partially a IncidentTask entity.
   *
   * id String Identifier of the IncidentTask
   * incidentTask IncidentTask_Update The IncidentTask to be updated
   * returns IncidentTask
   **/

  console.log('patchIncidentTask :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchIncidentTask',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchIncidentTask error=" + error);
...
exports.retrieveIncidentTask = function(req, res, next) {
  /**
   * Retrieves a IncidentTask by ID
   * This operation retrieves a IncidentTask entity. Attribute selection is enabled for all first level attributes.
   *
   * id String Identifier of the IncidentTask
  ...
  console.log('retrieveIncidentTask :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveIncidentTask: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
